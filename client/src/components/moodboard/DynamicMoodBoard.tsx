...
export default function DynamicMoodBoard({
  ...
  const calculateAndSetScale = useCallback(
    (originalWidth: number | null, originalHeight: number | null): number => {
      ...
      console.log("calculateAndSetScale - containerWidth:", containerWidth, "scale:", scale);
      setBoardScale(scale);
  ...
  return (
    <div className="pb-20 sm:pb-4 min-h-screen">
      ...
      {boardLoading && (
        ...
        >
          {[
            { top: "8%",  left: "8%",  size: 8,  delay: "0s",    dur: "3.2s" },
            { top: "12%", left: "55%", size: 18, delay: "0.4s",  dur: "4.1s" },
            { top: "15%", left: "80%", size: 10, delay: "1.1s",  dur: "3.5s" },
            { top: "20%", left: "30%", size: 22, delay: "1.8s",  dur: "4.3s" },
            { top: "25%", left: "92%", size: 7,  delay: "0.7s",  dur: "3.8s" },
            { top: "30%", left: "15%", size: 14, delay: "2.2s",  dur: "4.0s" },
            { top: "33%", left: "68%", size: 9,  delay: "0.3s",  dur: "3.3s" },
            { top: "38%", left: "45%", size: 20, delay: "1.5s",  dur: "4.2s" },
            { top: "42%", left: "5%",  size: 11, delay: "2.6s",  dur: "3.7s" },
            { top: "45%", left: "78%", size: 7,  delay: "0.9s",  dur: "4.4s" },
            { top: "50%", left: "22%", size: 18, delay: "1.9s",  dur: "3.1s" },
            { top: "53%", left: "88%", size: 9,  delay: "1.3s",  dur: "4.0s" },
            { top: "58%", left: "40%", size: 13, delay: "0.6s",  dur: "3.6s" },
            { top: "62%", left: "12%", size: 22, delay: "2.0s",  dur: "4.5s" },
            { top: "65%", left: "60%", size: 8,  delay: "1.4s",  dur: "3.2s" },
            { top: "70%", left: "35%", size: 16, delay: "0.2s",  dur: "4.1s" },
            { top: "73%", left: "82%", size: 10, delay: "2.4s",  dur: "3.8s" },
            { top: "78%", left: "50%", size: 7,  delay: "1.0s",  dur: "3.4s" },
            { top: "82%", left: "18%", size: 19, delay: "1.7s",  dur: "4.2s" },
            { top: "86%", left: "70%", size: 9,  delay: "0.8s",  dur: "3.9s" },
            { top: "90%", left: "38%", size: 14, delay: "2.1s",  dur: "4.0s" },
            { top: "93%", left: "90%", size: 11, delay: "1.6s",  dur: "3.3s" },
            { top: "5%",  left: "42%", size: 7,  delay: "2.8s",  dur: "3.7s" },
            { top: "48%", left: "95%", size: 16, delay: "0.5s",  dur: "4.3s" },
          ].map((sp, i) => (
            <span
              key={i}
              style={{
                ...
                clipPath: "polygon(50% 5%, 58% 42%, 95% 50%, 58% 58%, 50% 95%, 42% 58%, 5% 50%, 42% 42%)",
